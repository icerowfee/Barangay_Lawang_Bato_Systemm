...
class ShowApprovedCedulaRequests extends Component
{
    use WithPagination;
    ...
    {
        $this->resetPage('approved_cedula_page');
    }
    ...
    public function render()
    {
        ...
        $approvedCedulaRequests = $query->where('status', 'Approved')->where('request_expires_at', '>', now())->oldest()->paginate(9, ['*'], 'approved_cedula_page')
        ...
        return view('livewire.show-approved-cedula-requests', [
