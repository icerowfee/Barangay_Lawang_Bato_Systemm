...
@if ($reporterType == '1')
    ...
    <footer>
        Generated on {{ \Carbon\Carbon::now()->format('F j, Y - h:i A') }} &nbsp;|&nbsp; {{$adminUserFirstname . ' ' . $adminUserLastname}} &nbsp;|&nbsp; Document Issuance Admin
        {{-- Page numbers: Add manually via script if needed --}}
    </footer>
    
    

@elseif ($reporterType == '2')
    <header>
        <img src="{{ public_path('images/lawang-bato-logo.png') }}" alt="Barangay Lawang Bato">
    ...
    <footer>
        Generated on {{ \Carbon\Carbon::now()->format('F j, Y - h:i A') }} &nbsp;|&nbsp; {{$adminUserFirstname . ' ' . $adminUserLastname}} &nbsp;|&nbsp; Job Referral Admin
        {{-- Page numbers: Add manually via script if needed --}}
    </footer>
