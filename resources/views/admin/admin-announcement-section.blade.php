...
<body class="flex h-screen bg-gray-100" x-data="{
    ...
    <div class="relative h-screen flex-1 p-8 overflow-y-scroll">
        ...
        <div class="fixed bottom-2.5 right-8 flex justify-end w-full p-4">
            <div class="space-x-4">
        ...
        <div x-cloak x-show="showAnnouncementModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div class=" relative bg-white p-6 rounded-lg shadow-lg w-[750px] h-content">
                <div class="flex justify-between mb-2">
                    ...
                    <button class=" text-[15px] max-h-[25px] w-6 text-black" @click="showAnnouncementModal = false; activeTab = ''; cancelEditing()">
                        X
                    </button>
                </div>
                ...
                <div class=" w-[702px] flex justify-center self-center">
                    ...
                    <div class="flex justify-between w-[225px]" x-cloak x-show="editMode">
                        <form action="{{route('edit.announcement')}}" method="POST" enctype="multipart/form-data"> {{-- Need ayusin yung sa file upload, hindi na uupload yung image sa storage--}}
                            ...
                            <input type="hidden" name="activeTab" value="selected-announcement-tab">
                        ...
                        <button class="bg-red-500 text-white px-6 py-2 rounded-md hover:bg-red-600 transition h-[40px]" @click="cancelEditing()">
                            Cancel
                        </button>
            ...
            <form action="{{route('add.announcement')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="announcement_type" value="Job Announcement" class="w-full border p-2 rounded-lg" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4">
                    <button class="px-4 py-2 bg-gray-400 text-white rounded-lg" @click="showModal = false">Cancel</button>
                    <button class="px-4 py-2 bg-green-500 text-white rounded-lg">Add</button>
                </div>
            </form>
        </div>
    </div>
